    ...
    <>
      ...
      <div className="flex flex-col lg:flex-row gap-5">
        <div className="lg:w-1/3 flex flex-col gap-5">
          <div className="p-5 dark:bg-gray-light bg-[#E3E3E4] flex flex-col gap-5 rounded-lg">
            <p className="text-yellow-light text-2xl ">دسته بندی ها</p>
            <ListGruop items={categoyFilter} classes={"text-white gap-5"}>
              <Checkbox classes={"text-[#232323] dark:text-white text-md gap-3"} />
            </ListGruop>
          </div>
          <div className="flex flex-col p-5 gap-5 dark:bg-gray-light bg-[#E3E3E4] rounded-lg">
        ...
        <div className="lg:w-2/3 dark:bg-gray-light bg-[#E3E3E4] rounded-lg flex flex-col gap-20 px-3 pt-20 pb-2">
