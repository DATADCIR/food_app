    ...
    <div className="w-full bg-yellow-light flex px-5 py-2 rounded-lg gap-5 ">
      <div className="relative w-2/12 sm:w-1/12">
        <Image
          ...
          width={182}
          height={182}
          className="absolute top-0 right-0 translate-x-1/4 -translate-y-1/2    md:translate-x-1/5 md:-translate-y-1/2 xl:translate-y-3 xl:translate-x-1/4 scale-150   sm:scale-175  md:scale-200 xl:scale-175"
        />
      </div>
